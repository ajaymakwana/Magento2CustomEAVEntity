 ...
 */
namespace Ajay\Brand\Model\Category\Attribute;
 ...
 */
class Repository implements \Ajay\Brand\Api\Category\CategoryAttributeRepositoryInterface
{
    /**
    ...
    public function get($attributeCode)
    {
        return $this->eavAttributeRepository->get(
            \Ajay\Brand\Api\Data\Category\CategoryAttributeInterface::ENTITY_TYPE_CODE,
            $attributeCode
        );
    }
