 ...
 * Life is a code
 */
namespace Ajay\Brand\Controller\Category;
...
class View extends \Ajay\Brand\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $this->_objectManager->get('\Magento\Framework\Registry')
            ->register('current_brand_category', $category);
     ...
     * Init category
     *
     * @return \Ajay\Brand\Model\category || false
     */
    protected function _initCategory()
    {
        ...
        $category = $this->_objectManager->create('Ajay\Brand\Model\Category')->load($id);
