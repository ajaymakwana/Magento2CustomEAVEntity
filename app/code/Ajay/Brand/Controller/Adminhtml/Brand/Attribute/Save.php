 ...
 */
class Save extends \Ajay\Brand\Controller\Adminhtml\Brand\Attribute\Attribute
{
    /**
...
//            }
            ...
            if ($attributeId) {
                ...
                if (!$model->getId()) {
                    ...
                    return $this->returnResult('brand/brand_attribute/*/', [], ['error' => true]);
                }
            ...
            $defaultAttributeSetId = $this->_objectManager->get('Magento\Eav\Model\Config')
                    ->getEntityType(\Ajay\Brand\Model\Brand\Attribute::ENTITY)
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('You saved the brand attribute.'));

                $this->_session->setAttributeData(false);
                if ($this->getRequest()->getParam('back', false)) {
                    return $this->returnResult(
                        'brand/brand_attribute/edit',
                        ['attribute_id' => $model->getId(), '_current' => true],
                        ['error' => false]
                    );
                }
                return $this->returnResult('brand/attribute/*/', [], ['error' => false]);
            } catch (\Exception $e) {
