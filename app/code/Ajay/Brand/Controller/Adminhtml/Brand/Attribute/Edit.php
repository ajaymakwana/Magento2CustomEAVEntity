...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Ajay_Brand::brand_attributes')
            ->addBreadcrumb(__('Brand Attributes'), __('Brand Attributes'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Brand Attributes'));
        return $resultPage;
    }
    ...
    protected function createActionPage($title = null)
    {
        ...
        $resultPage->addBreadcrumb(__('Brand'), __('Brand'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Brand Attributes'))
            ->setActiveMenu('Ajay_Brand::brand_attributes');
        if (!empty($title)) {
    ...
    public function dispatch(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        $this->_entityTypeId = $this->_objectManager->create(
            ...
            \Ajay\Brand\Model\Brand\Attribute::ENTITY
        )->getTypeId();
