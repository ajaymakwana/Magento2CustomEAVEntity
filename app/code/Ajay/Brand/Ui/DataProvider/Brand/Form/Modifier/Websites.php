...
class Websites extends AbstractModifier
{
    ...
    {
        $modelId = $this->locator->getBrand()->getId();
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'label' => __('Brand in Websites'),
                                    'collapsible' => true,
                                    'componentType' => Form\Fieldset::NAME,
                                    'dataScope' => self::DATA_SCOPE_BRAND,
                                    'disabled' => false,
    ...
    protected function getFieldsForFieldset()
    {
        ...
        $isNewProduct = !$this->locator->getBrand()->getId();
        $tooltip = [
    ...
    /**
     * Return array of websites ids, assigned to the brand
     *
     * @return array
     */
    protected function getWebsitesValues()
    {
        return $this->locator->getBrandWebsiteIds();
    }
}
