...
class Related extends AbstractModifier
{
    ...
    {
        /** @var \Ajay\Brand\Model\Brand $brand */
        ...
        $items = [];
        $collection = $brand->getRelatedProductCollection()->addAttributeToSelect('name');
        ...
        $data[$brandId]['links']['product'] = $items;

        $data[$brandId]['current_brand_id'] = $brandId;
        $data[$brandId]['current_store_id'] = $this->locator->getStore()->getId();
