...
namespace Ajay\Brand\Block\Adminhtml\Brand\Edit\Tab;
...
//class Form extends \Magento\Catalog\Block\Adminhtml\Form
{
    ...
    {
        return [
            'image' => 'Ajay\Brand\Block\Adminhtml\Brand\Helper\Image'
        ];
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Brand Details')]);

        $attributes = $this->getAttributes();

        $entity = $this->getEavConfig()->getEntityType(\Ajay\Brand\Model\Brand::ENTITY)->getEntity();
