...
namespace Ajay\Brand\Block\Adminhtml\Brand;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
   ...
   // private $_status;
    ...
    public function __construct(
       ...
       // $this->_bannerbrandHelper = $bannerbrandHelper;
       // $this->_status = $status;
    }
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->joinAttribute('title','ajay_brand/title','entity_id',null,'left',$adminStoreId);
